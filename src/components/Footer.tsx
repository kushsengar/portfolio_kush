            ...
            <div className="container-main py-16">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-3">
                        <Link
                            href="/"
                            className="text-xl font-bold text-text-primary group"
                        >
                            {siteConfig.name.split(" ")[0]}
                            <span className="text-accent group-hover:scale-125 inline-block transition-transform">.
                            </span>
                        </Link>
                    ...
                    <div className="flex items-center gap-3">
                        {[
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-text-secondary hover:text-accent hover:border-accent/30 hover:bg-accent/5 transition-all duration-300"
